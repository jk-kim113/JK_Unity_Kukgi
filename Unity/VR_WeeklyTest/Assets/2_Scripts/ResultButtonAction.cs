...
public class ResultButtonAction : MonoBehaviour
{
    enum eResultType
    {
        Replay = 0,
...
#pragma warning restore
    ...
    private void Awake()
    {
        ...
        entry3.callback.AddListener(delegate { ClickButton(); });
    ...
    void ClickButton()
    {
        switch(_nowResultType)
        {
            case eResultType.Replay:

                SceneManager.LoadScene("IngameScene");

                break;
            case eResultType.Exit:
