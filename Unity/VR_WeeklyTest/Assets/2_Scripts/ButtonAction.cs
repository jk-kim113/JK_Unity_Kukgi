...
#pragma warning disable 0649
    [SerializeField]
    IngameManager.eDifficultyType _difficultType;
#pragma warning restore
    ...
    private void Awake()
    {
        ...
        entry3.callback.AddListener(delegate { ClickButton(_difficultType); });
    ...
    void ClickButton(IngameManager.eDifficultyType _type)
    {
        IngameManager._instance.SelectDifficulty(_type);
    }
}
